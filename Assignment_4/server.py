...
async def draw_rectangle(x1: int, y1: int, x2: int, y2: int) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(810, 132))
        paint_window.press_mouse_input(coords=(810, 132))  # Press mouse
        time.sleep(0.2)
...
async def add_text_in_paint(text: str) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(883, 295))
        time.sleep(0.5)
        # Click where to start typing
        paint_window.click_input(coords=(753, 636))
        paint_window.click_input(coords=(758, 630))
        time.sleep(0.5)
        ...
        paint_window.click_input(coords=(1050, 800))
...
def send_email(to: str, subject: str, body: str):
    ...
    Example:
        send_email("someone@example.com", "Meeting Update", "Hey, let's meet at 5 PM.")
    """
